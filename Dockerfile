...
RUN mkdir -p /usr/src/madico_geonode
...
COPY src /usr/src/madico_geonode/
WORKDIR /usr/src/madico_geonode
...
RUN chmod +x /usr/src/madico_geonode/tasks.py \
    && chmod +x /usr/src/madico_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/madico_geonode/entrypoint.sh
