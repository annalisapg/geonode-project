...
RUN mkdir -p /usr/src/enea_geonode
...
COPY src /usr/src/enea_geonode/
WORKDIR /usr/src/enea_geonode
...
RUN chmod +x /usr/src/enea_geonode/tasks.py \
    && chmod +x /usr/src/enea_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/enea_geonode/entrypoint.sh
